...
Copy-Item -Force "$project_dir\Packages\com.nickmaltbie.statemachineunity\CHANGELOG.md" "$dir\changelog\CHANGELOG.md"
...
foreach ($tag in $versions)
{
    ...
    if (Test-Path "$project_dir\Packages\com.nickmaltbie.statemachineunity\CHANGELOG.md")
    {
        Copy-Item -Force "$project_dir\Packages\com.nickmaltbie.statemachineunity\CHANGELOG.md" "$dir\changelog\CHANGELOG.md" > $null
    }
    if (Test-Path "$project_dir\Packages\com.nickmaltbie.statemachineunity.netcode\CHANGELOG.md")
    {
        Copy-Item -Force "$project_dir\Packages\com.nickmaltbie.statemachineunity.netcode\CHANGELOG.md" "$dir\changelog\CHANGELOG.netcode.md" > $null
    }
